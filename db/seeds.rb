...
red_shell = Shell.create(color: "Red", image: "snail_shell_red")
orange_shell = Shell.create(color: "Orange", image: "snail_shell_orange")
yellow_shell = Shell.create(color: "Yellow", image: "snail_shell_yellow")
green_shell = Shell.create(color: "Green", image: "snail_shell_green")
blue_shell = Shell.create(color: "Blue", image: "snail_shell_blue")
purple_shell = Shell.create(color: "Teal", image: "snail_shell_teal")
black_shell = Shell.create(color: "Black", image: "snail_shell_black")
white_shell = Shell.create(color: "White", image: "snail_shell_white")
gold_shell = Shell.create(color: "Gold", image: "snail_shell_gold")

red_body = Body.create(color: "Red", image: "snail_body_red")
orange_body = Body.create(color: "Orange", image: "snail_body_orange")
yellow_body = Body.create(color: "Yellow", image: "snail_body_yellow")
green_body = Body.create(color: "Green", image: "snail_body_green")
blue_body = Body.create(color: "Blue", image: "snail_body_blue")
purple_body = Body.create(color: "Purple", image: "snail_body_purple")
black_body = Body.create(color: "Black", image: "snail_body_black")
gray_body = Body.create(color: "Gray", image: "snail_body_gray")
gold_body = Body.create(color: "Gold", image: "snail_body_gold")
...
cabbage = Prize.create(name: "Cabbage", image: "cabbage")
carrot = Prize.create(name: "Carrot", image: "carrot")
strawberry = Prize.create(name: "Strawberry", image: "strawberry")
mushroom = Prize.create(name: "Mushroom", image: "mushroom")
